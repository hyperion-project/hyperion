...
X11Wrapper::X11Wrapper(int grabInterval, bool dominantColor, int cropLeft, int cropRight, int cropTop, int cropBottom, int horizontalPixelDecimation, int verticalPixelDecimation) :
    _timer(this),
    _grabber(dominantColor, cropLeft, cropRight, cropTop, cropBottom, horizontalPixelDecimation, verticalPixelDecimation)
{
